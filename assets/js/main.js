...
const translations = {
  en: {
    ...
    eyebrow: "markka.net",
    subtitle:
      "Junior full-stack developer with finance-grade rigor. I focus on backend services, data handling, and clean interfaces.",
    statusOpen: "Open to junior developer roles",
    heroHeading: "From finance rigor to software craft",
    heroLead:
      "I build dependable backend services, clear APIs, and data workflows. I value clarity, ownership, and steady delivery, and I enjoy working in teams that care about how things are built.",
    ctaContact: "Contact me",
    ctaProjects: "View projects",
    statLabel1: "ranked in my starting batch",
    ...
    leadership1Body: "Organized fundraising and operations; raised ~€100k to protect forest with focus on biodiversity.",
    leadership2Title: "Board Member — E3 Innovations Oy",
    leadership2Meta: "11/2021 – 10/2024",
    leadership2Body: "Vehicle data analytics startup exposure to business and fund raising strategy.",
    ...
    eyebrow: "markka.net",
    subtitle:
      "Junior full-stack -kehittäjä finanssitaustalla. Keskityn backend-palveluihin, datan käsittelyyn ja selkeisiin rajapintoihin.",
    statusOpen: "Avoin juniorikehittäjän rooleille",
    heroHeading: "Finanssitaustasta ohjelmistokehitykseen",
    heroLead:
      "Rakennan luotettavia backend-palveluita, selkeitä rajapintoja ja datavirtoja. Arvostan selkeyttä, vastuunkantoa ja tasaisesti etenevää tekemistä, ja viihdyn tiimeissä, joissa tekemisen laatu on tärkeää.",
    ctaContact: "Ota yhteyttä",
    ctaProjects: "Katso projektit",
    statLabel1: "sijoitus omassa aloituserässä",
    statLabel2: "kood/Sisu × Documtec -hackathon",
    ...
    focusItem3: "Suuntautumassa järjestelmätason ohjelmistojen ja sulautettujen ohjelmistojen pariin",
    ...
    education3Title: "Lancaster University — Postgraduate Diploma in Finance",
    education3Meta: "10/2018 – 09/2019",
    education3Body: "Lopputyö Pythonilla: web scraping, ulkoiset datahaut ja arvonmääritysmallit.",
    education4Title: "Católica Lisbon School of Business & Economics — BSc Management",
    education4Meta: "09/2015 – 08/2018",
    ...
    leadership1Body:
      "Varainhankinta ja operatiivinen toiminta; kerätty noin €100k metsien suojeluun biodiversiteettifokuksella.",
    leadership2Title: "Board Member — E3 Innovations Oy",
    leadership2Meta: "11/2021 – 10/2024",
    leadership2Body: "Ajoneuvodataa hyödyntävä startup; näkökulmaa liiketoiminta- ja varainkeruustrategiaan.",
