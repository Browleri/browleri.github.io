...
const translations = {
  en: {
    ...
    heroHeading: "Junior developer with finance-grade rigor",
    heroLead:
      "I build dependable backend services, clear APIs, and data workflows. I value clarity, ownership, and steady delivery - a strong fit for Nordic engineering culture.",
    ...
    focusItem1: "Backend services in Go, SQL, and JavaScript",
    focusItem2: "Building reliable backend services and REST APIs",
    focusItem3: "Clear communication, code reviews, and documentation",
    ...
    eyebrow: "markka.net",
    subtitle:
      "Junior full-stack -kehittäjä finanssitaustalla. Keskityn backend-palveluihin, dataan ja selkeisiin rajapintoihin.",
    statusOpen: "Avoin juniorikehittäjän rooleille",
    heroHeading: "Junior-kehittäjä finanssitaustalla",
    heroLead:
      "Rakennan luotettavia backend-palveluja, selkeitä API-rajapintoja ja data-työnkulkuja. Arvostan selkeyttä, omistajuutta ja tasaista toimitusta - hyvin linjassa pohjoismaisen insinöörikulttuurin kanssa.",
    ...
    focusItem1: "Backend-palvelut Go:lla, SQL:llä ja JavaScriptillä",
    focusItem2: "Luotettavat backend-palvelut ja REST API:t",
    focusItem3: "Selkeä viestintä, code review ja dokumentointi",
