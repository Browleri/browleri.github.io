...
const translations = {
  en: {
    ...
    statLabel1: "ranked in 2024 cohort",
    ...
    projectTitle2: "Go Service Sandbox",
    projectMeta2: "Backend • REST APIs • SQL",
    projectDesc2: "Peer-reviewed Go services with clean data models, query layers, and API contracts.",
    projectTitle3: "Investment Workflow Automations",
    projectMeta3: "Python • Data workflows • Reporting",
    projectDesc3: "Created internal tools to speed up analysis and reporting for finance teams.",
    ...
    eyebrow: "markka.net",
    subtitle:
      "Full-stack-opiskelija ja uranvaihtaja finanssista. Keskityn backend-järjestelmiin, dataan ja selkeisiin rajapintoihin.",
    ...
    statLabel1: "sijoitus 2024-kohortin top 8 %",
    statLabel2: "kood/Sisu × Documtec -hackathon",
    ...
    aboutBody1: "Olen uranvaihtaja ohjelmistokehitykseen, taustana vahva analytiikka finanssialalta.",
    aboutBody2:
    ...
    education1Body: "Vertaisarvioitu ohjelma Go:lla, SQL:llä ja JavaScriptillä oikeilla aineistoilla.",
    education2Title: "Harvard University — CS50x",
    education2Meta: "04/2025 – 07/2025",
    education2Body:
    ...
    projectTitle2: "Go Service Sandbox",
    projectMeta2: "Backend • REST API:t • SQL",
    projectDesc2: "Vertaisarvioidut Go-palvelut selkeillä datamalleilla, kyselykerroksilla ja API-sopimuksilla.",
    projectTitle3: "Investment Workflow Automations",
    projectMeta3: "Python • Data-työnkulut • Raportointi",
    projectDesc3: "Rakensin sisäisiä työkaluja analyysin ja raportoinnin nopeuttamiseksi finanssitiimeille.",
